...
print(f'\nMarch total: {total} articles across {sum(1 for v in found_by_date.values() if v)} days')
...
with open(r'd:\zjun\新时代文学LLMWIKI\scripts\_tmp_manifest_march.pkl', 'wb') as pf:
