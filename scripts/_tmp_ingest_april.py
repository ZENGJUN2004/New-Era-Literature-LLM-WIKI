"""
Ingest April 2026: 422 unique articles
"""
...
with open(r'd:\zjun\新时代文学LLMWIKI\scripts\_tmp_manifest_april.pkl', 'rb') as mf:
...
print(f'People: {len(new_people)}, Events: {len(new_events)}, Themes: {len(new_themes)}, Light: {light_count}')
...
- 【Ingest】批量处理 422 篇，轻处理 {light_count} 篇
